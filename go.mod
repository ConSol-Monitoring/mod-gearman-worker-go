...
require (
	...
	github.com/consol-monitoring/check_prometheus v0.0.0-20260109154714-5ada433aa2c7
...
require (
	...
	github.com/consol-monitoring/check_x v0.0.0-20260108170459-f7c19720a9ad // indirect
